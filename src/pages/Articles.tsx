...
export default function ArticlesPage() {
  return (
    <div className="bg-gradient-to-l top-0 right-0 
    ...
    <div className="py-24 sm:py-32">
      <div className="mx-auto text-white max-w-7xl px-6 lg:px-8">
        <div className="mx-auto text-center max-w-2xl lg:mx-0">
          <h2 className="text-pretty text-4xl font-semibold tracking-tight text-neutral-50 sm:text-5xl">
            From the blog
          </h2>
          <p className="mt-2 text-lg/8 text-neutral-50">
            ...
            >
              ...
              <div className="flex items-start px-3 my-3 text-white  flex-col">
                ...
                <div className="group  border-b border-gray-200 pb-3 relative">
                  <h3 className="mt-2 text-lg/6 font-semibold text-neutral-50 group-hover:text-gray-600">
                    <a href={"/"}>
                ...
                <div className="flex space-y-2 w-fit flex-col">
                  ...
                  variant={'destructive'}
                    ...
                    className="relative z-10  w-fit rounded-full bg-gray-600 px-3 py-1.5 font-medium text-gray-50 hover:bg-gray-100"
                  >
                    Lire plus
                  </Button>
                </div>
